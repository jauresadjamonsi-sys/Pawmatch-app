  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8">
      ...
      <button
        ...
        className="w-full py-3 bg-white border-2 border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold rounded-xl transition flex items-center justify-center gap-3 mb-6"
      >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white text-gray-400">ou par email</span>
        </div>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        <Link href="/forgot-password" className="text-orange-500 hover:underline font-medium text-sm">Mot de passe oublié ?</Link>
      </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-orange-500">Compaw</h1>
