    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <button onClick={handleGoogleSignup} className="w-full py-3 bg-white/10 border border-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition flex items-center justify-center gap-3 mb-6">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-4 bg-[#1a1225] text-gray-500">ou par email</span></div>
          </div>
