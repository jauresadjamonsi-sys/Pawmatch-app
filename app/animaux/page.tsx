          ...
          {CANTONS_SEO.map((canton) => {
            ...
            return (
              <Link
                ...
                className="group block bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg hover:border-amber-200 transition-all duration-200"
              >
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-semibold text-gray-900 group-hover:text-amber-500 transition-colors">
                    {canton.name}
                  </h3>
                  <span className="text-sm font-medium text-amber-500 bg-amber-50 px-3 py-1 rounded-full">
