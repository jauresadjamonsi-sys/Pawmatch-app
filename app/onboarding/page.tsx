        ...
        <div className="flex justify-center gap-2 mb-8">
          {[1, 2, 3, 4, 5, 6].map((s) => (
            <div key={s} className={"h-1.5 rounded-full transition-all duration-500 " + (s <= step ? "w-10" : "w-6")}
              style={{ background: s <= step ? "var(--c-accent, #F59E0B)" : "var(--c-border)" }} />
          ))}
        </div>
            ...
            <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-6 space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-amber-400 mt-1 font-medium">Obligatoire *</p>
                </div>
              </div>
              ...
              <div>
                ...
                <input type="text" value={name} onChange={(e) => setName(e.target.value)}
                  className="w-full px-4 py-3 bg-[var(--c-bg)] border border-[var(--c-border)] rounded-xl text-[var(--c-text)] placeholder-[var(--c-text-muted)] focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition"
              ...
              {breedList.length > 0 && (
                <div>
                  ...
                  <select value={breed} onChange={(e) => setBreed(e.target.value)}
                    className="w-full px-4 py-3 bg-[var(--c-bg)] border border-[var(--c-border)] rounded-xl text-[var(--c-text-muted)] focus:ring-2 focus:ring-amber-500 outline-none appearance-none">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <label className="w-full cursor-pointer">
                  <div className="w-full py-3 text-center font-bold rounded-xl transition border-2"
                    style={{
                      background: verifPreview ? "rgba(245,158,11,0.08)" : "var(--c-bg)",
                      borderColor: verifPreview ? "rgba(245,158,11,0.3)" : "var(--c-border)",
                      color: verifPreview ? "#F59E0B" : "var(--c-text-muted)",
                    }}>
        ...
        {step === 4 && (
          <div className="fade-in-up">
            ...
            <button
              ...
              style={{ background: referralApplied ? "#F59E0B" : "var(--c-text, #111827)" }}
            >
        ...
        {step === 5 && (
          <div className="fade-in-up">
            ...
            <button
              ...
              style={{ background: "#F59E0B", boxShadow: "0 0 30px rgba(34, 197, 94,0.3)" }}
            >
              C&apos;est parti !
            </button>
          </div>
        ...
        {step === 6 && (
          <div className="text-center fade-in-up">
            ...
            <p className="text-sm text-[var(--c-text-muted)] mb-2">
              <span className="font-bold" style={{ color: "var(--c-accent, #F59E0B)" }}>{name}</span> {t.onboardReadyMsg}
            </p>
