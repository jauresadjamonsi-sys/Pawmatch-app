            ...
            <div className="space-y-4">
              ...
              {!profile && (
                <p className="text-center text-xs text-[var(--c-text-muted)]">
                  <Link href="/login" className="text-amber-300">Connectez-vous</Link> pour lancer un live
                </p>
              )}
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
          ...
          <div className="max-h-48 overflow-y-auto px-4 pb-2 space-y-1.5">
            {chatMessages.map(msg => (
              <div key={msg.id} className="flex items-start gap-2">
                <span className="text-xs font-bold text-amber-300 whitespace-nowrap">{msg.user}</span>
          ...
          <div className="flex items-center gap-2 px-4 pb-6 pt-1">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 flex items-center justify-center text-white shadow-lg disabled:opacity-40 transition-all"
            >
