      ...
      {sent && sentAnimal ? (
        <div className="glass-strong rounded-2xl p-6 text-center space-y-4 animate-bounce-in">
          {sentAnimal.photo_url && (
            <div className="relative w-32 h-32 mx-auto rounded-2xl overflow-hidden border-2 border-green-500/30">
              <Image
        ...
        <form onSubmit={handleSubmit} className="glass rounded-2xl p-5 space-y-5">
          ...
          <div>
            ...
            {animals.length === 0 ? (
              <p className="text-sm text-[var(--c-text-muted)]">
                ...
                <Link href="/animals/new" className="text-green-500 underline">
                  Ajoute ton animal
                </Link>{" "}
                d'abord.
              </p>
                  ...
                  <button
                    ...
                    className={
                      ...
                      (selectedAnimalId === animal.id
                        ...
                        : "border-[var(--c-border)] hover:border-green-500/40")
                    }
                  >
                    {animal.photo_url ? (
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-[var(--c-deep)] border border-[var(--c-border)] text-[var(--c-text)] placeholder:text-[var(--c-text-muted)] text-sm focus:outline-none focus:border-green-500 transition"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-[var(--c-deep)] border border-[var(--c-border)] text-[var(--c-text)] text-sm focus:outline-none focus:border-green-500 transition"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-xl bg-[var(--c-deep)] border border-[var(--c-border)] text-[var(--c-text)] placeholder:text-[var(--c-text-muted)] text-sm focus:outline-none focus:border-green-500 transition resize-none"
            />
          </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-xs font-bold text-green-500 hover:text-green-400 transition px-3 py-1.5 rounded-full border border-green-500/30 hover:bg-green-500/10"
                    >
                      Je l'ai vu !
                    </Link>
                  </div>
