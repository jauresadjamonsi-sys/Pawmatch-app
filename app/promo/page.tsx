...
const TEMPLATES: PromoTemplate[] = [
  {
    ...
    whatsappText:
      "Et si ton chien trouvait son meilleur ami ? PawlyApp connecte les animaux et leurs proprios en Suisse. Inscris-toi gratuitement !",
  ...
  },
  {
    ...
    whatsappText:
      "La plus grande communaute d'animaux de compagnie en Suisse est sur PawlyApp ! Rejoins-nous, c'est gratuit.",
  ...
  },
  {
    ...
    whatsappText:
      "Fini les balades seul avec ton chien ! Sur PawlyApp, trouve des compagnons de promenade pres de chez toi. Gratuit !",
  ...
  },
  {
    ...
    whatsappText:
      "Le Tinder des animaux existe et c'est suisse ! Ton compagnon merite de trouver son match. Essaie PawlyApp maintenant !",
  ...
  },
  {
    ...
    title: "100% Gratuit",
    whatsappText:
      "PawlyApp, l'app gratuite qui connecte les proprietaires d'animaux en Suisse. Inscris-toi en 30 secondes !",
