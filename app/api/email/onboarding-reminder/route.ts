          ...
          await resend.emails.send({
            ...
            html: `<div style="max-width:500px;margin:0 auto;font-family:-apple-system,sans-serif;background:#1a1225;color:#fff;border-radius:16px;overflow:hidden">
              ...
              <div style="padding:24px">
                ...
                <p style="font-size:15px;line-height:1.6;color:#e0e0e0">En <strong style="color:#22c55e">2 minutes</strong>, présente-le à la communauté et trouve des copains de balade près de chez toi.</p>
                ...
                <a href="https://pawlyapp.ch/profile/animals/new" style="display:block;padding:14px;background:#22c55e;color:#fff;text-align:center;border-radius:12px;font-weight:700;font-size:15px;text-decoration:none">Ajouter mon animal →</a>
