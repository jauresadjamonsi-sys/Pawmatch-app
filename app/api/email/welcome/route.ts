...
export async function POST(request: Request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: email,
      subject: "🐾 Bienvenue sur PawlyApp !",
      html: `<div style="max-width:500px;margin:0 auto;font-family:-apple-system,sans-serif;background:#1a1225;color:#fff;border-radius:16px;overflow:hidden"><div style="background:linear-gradient(135deg,#FBBF24,#F59E0B);padding:32px;text-align:center"><h1 style="margin:0;font-size:28px">🐾 Bienvenue ${firstName} !</h1><p style="margin:8px 0 0;opacity:0.9;font-size:14px">Ton aventure PawlyApp commence maintenant</p></div><div style="padding:24px"><h2 style="font-size:18px;color:#FBBF24;margin-bottom:16px">Tes 3 premières étapes :</h2><div style="background:rgba(255,255,255,0.05);border-radius:12px;padding:16px;margin-bottom:12px"><p style="margin:0;font-size:14px"><strong style="color:#FBBF24">1️⃣ Ajoute ton animal</strong></p><p style="margin:4px 0 0;font-size:13px;color:#9ca3af">Photo, race, personnalité — crée son profil unique</p></div><div style="background:rgba(255,255,255,0.05);border-radius:12px;padding:16px;margin-bottom:12px"><p style="margin:0;font-size:14px"><strong style="color:#FBBF24">2️⃣ Fais le test de personnalité</strong></p><p style="margin:4px 0 0;font-size:13px;color:#9ca3af">Découvre le type de ton compagnon et ses copains idéaux</p></div><div style="background:rgba(255,255,255,0.05);border-radius:12px;padding:16px;margin-bottom:12px"><p style="margin:0;font-size:14px"><strong style="color:#FBBF24">3️⃣ Commence à flairer</strong></p><p style="margin:4px 0 0;font-size:13px;color:#9ca3af">Trouve des copains de balade près de chez toi</p></div><a href="https://pawlyapp.ch/profile/animals/new" style="display:block;margin-top:20px;padding:14px;background:#FBBF24;color:#fff;text-align:center;border-radius:12px;font-weight:700;font-size:14px;text-decoration:none">Ajouter mon premier animal →</a><div style="margin-top:20px;padding:16px;background:rgba(13,148,136,0.1);border-radius:12px;border:1px solid rgba(13,148,136,0.2)"><p style="margin:0;font-size:12px;color:#0D9488">💡 <strong>Astuce :</strong> Trouve un véto ou toiletteur sur <a href="https://pawdirectory.ch" style="color:#0D9488;font-weight:700">PawDirectory.ch</a></p></div></div><div style="padding:16px;text-align:center;border-top:1px solid rgba(255,255,255,0.05)"><p style="margin:0;font-size:11px;color:#6b7280">PawlyApp — Ton compagnon de sortie en Suisse 🇨🇭</p></div></div>`,
    });
