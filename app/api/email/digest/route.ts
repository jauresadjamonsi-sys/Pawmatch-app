      ...
      const html = `<div style="max-width:500px;margin:0 auto;font-family:-apple-system,sans-serif;background:#1a1225;color:#fff;border-radius:16px;overflow:hidden">
        ...
        <div style="padding:24px">
          ${newAnimalsCount > 0 ? `<div style="background:rgba(255,255,255,0.05);border-radius:12px;padding:16px;margin-bottom:12px">
            <p style="margin:0;font-size:14px"><strong style="color:#f97316">${newAnimalsCount} nouveaux animaux</strong> dans ton canton</p>
          ...
          <div style="background:rgba(255,255,255,0.05);border-radius:12px;padding:16px;margin-bottom:12px">
            <p style="margin:0;font-size:14px"><strong style="color:#f97316">${potentialMatches} matchs potentiels</strong> t'attendent</p>
            <p style="margin:4px 0 0;font-size:13px;color:#9ca3af">Reviens flairer pour trouver le copain ideal</p>
          </div>
          ${eventSection}
          <a href="https://pawlyapp.ch/flairer" style="display:block;margin-top:20px;padding:14px;background:#f97316;color:#fff;text-align:center;border-radius:12px;font-weight:700;font-size:14px;text-decoration:none">Revenir flairer</a>
