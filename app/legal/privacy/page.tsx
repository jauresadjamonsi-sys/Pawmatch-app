      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-[var(--c-text-muted)] text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>PawlyApp utilise uniquement des cookies strictement n&eacute;cessaires au fonctionnement du service :</p>
            <ul className="list-disc ml-5 mt-2 space-y-1">
          ...
          <section>
            ...
            <p>PawlyApp est destin&eacute; aux personnes &acirc;g&eacute;es de 18 ans ou plus. Nous ne collectons pas sciemment de donn&eacute;es de mineurs. Si nous d&eacute;couvrons qu&apos;un mineur a cr&eacute;&eacute; un compte, celui-ci sera supprim&eacute; imm&eacute;diatement. Si vous &ecirc;tes parent et pensez que votre enfant utilise PawlyApp, contactez-nous &agrave; <a href="mailto:contact@pawlyapp.ch" className="underline text-[var(--c-accent,#FBBF24)]">contact@pawlyapp.ch</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>PawlyApp propose des abonnements premium (PawPlus, PawPro) et des achats de PawCoins. Les paiements sont trait&eacute;s par Stripe (web) ou via les syst&egrave;mes d&apos;achat int&eacute;gr&eacute; d&apos;Apple et Google (mobile). Nous ne stockons aucune donn&eacute;e de carte bancaire.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2"><strong>PawlyApp</strong></p>
            <p>Email : <a href="mailto:contact@pawlyapp.ch" className="underline text-[var(--c-accent,#FBBF24)]">contact@pawlyapp.ch</a></p>
            <p>Site web : <a href="https://pawlyapp.ch" className="underline text-[var(--c-accent,#FBBF24)]">https://pawlyapp.ch</a></p>
          </section>
