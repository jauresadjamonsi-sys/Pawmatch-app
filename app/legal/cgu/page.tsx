      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-[var(--c-text-muted)] text-sm leading-relaxed">
          <section>
            ...
            <p>Les présentes CGU régissent l'utilisation de Pawband, plateforme de mise en relation entre proprietaires d animaux en Suisse, éditée par Pawband, Canton de Vaud, Suisse.</p>
          </section>
          <section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--c-text)] mb-2">3. Inscription</h2>
          ...
          <section>
            ...
            <p>Pawband propose la creation de profils animaux, un systeme de matching, une messagerie entre utilisateurs matches, un catalogue avec filtres, et des abonnements premium.</p>
          </section>
          <section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--c-text)] mb-2">6. Obligations</h2>
          ...
          <section>
            ...
            <p>Pawband est un service de mise en relation et ne peut etre tenu responsable des interactions entre utilisateurs ni des dommages lors de rencontres.</p>
          </section>
          <section>
            <h2 className="text-lg font-semibold text-[var(--c-text)] mb-2">8. Moderation</h2>
            <p>Pawband se reserve le droit de suspendre tout compte en cas de violation des CGU.</p>
          </section>
          <section>
