...
export default function FlairerPage() {
  ...
  function spawnParticles(x: number, y: number, type: "like"|"super"|"pass") {
    const colors = type === "like" ? ["#FBBF24","#4ADE80","#FCD34D","#f472b6","#ef4444"]
      : type === "super" ? ["#60a5fa","#a78bfa","#34d399","#FCD34D","#FBBF24"]
      : ["#6b7280","#9ca3af"];
      ...
      <div className="min-h-screen flex items-center justify-center bg-[var(--c-deep,#1a1225)]">
        ...
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 blur-xl bg-amber-400/20 rounded-full animate-breathe" />
          </div>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--c-deep,#1a1225)]">
        ...
        <div className="text-center max-w-sm animate-scale-in">
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 blur-2xl bg-amber-400/15 rounded-full animate-breathe" />
          </div>
        ...
        <div className="text-center max-w-sm animate-scale-in">
          ...
          <div className="glass-strong p-5 mt-6 mb-4 text-left">
            ...
            <div className="flex flex-col gap-3 stagger-children">
              <Link href="/events" className="flex items-center gap-3 text-sm text-[var(--c-text)] hover:text-amber-300 transition-colors duration-300">
                <span className="text-lg">{"📅"}</span> Découvre les événements près de toi
              </Link>
              <Link href="/carte" className="flex items-center gap-3 text-sm text-[var(--c-text)] hover:text-amber-300 transition-colors duration-300">
                <span className="text-lg">{"🗺️"}</span> Explore la carte des animaux
              </Link>
              <Link href="/matches" className="flex items-center gap-3 text-sm text-[var(--c-text)] hover:text-amber-300 transition-colors duration-300">
  ...
  const cardStyle = swipeDirection
    ...
    : {
        ...
        boxShadow: likeOpacity > 0
          ...
          : "0 20px 60px rgba(0,0,0,0.4), 0 0 40px rgba(34, 197, 94,0.05)",
      };
    ...
    <div className="min-h-screen flex flex-col items-center px-4 py-4 bg-[var(--c-deep,#1a1225)] select-none overflow-hidden page-transition">
      ...
      {showStreak && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[150] streak-pop">
          <div className="glass-strong neon-green text-[var(--c-text)] font-extrabold text-xl px-6 py-3 shadow-2xl">
            {streakLabel}
          </div>
        </div>
      )}
      ...
      {showCoupDeTruffe && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md" onClick={() => setShowCoupDeTruffe(false)}>
          <div className="relative glass-strong neon-green p-6 md:p-10 text-center max-w-sm mx-4 animate-bounce-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-20 h-20 rounded-full overflow-hidden ring-3 ring-amber-300/60 shadow-[0_0_20px_rgba(251,191,36,0.3)] flex-shrink-0 relative">
            ...
            <div className="text-left text-xs text-[var(--c-text-muted)] bg-[var(--c-bg)]/40 rounded-xl p-3 mb-5 space-y-1.5">
              <p className="font-semibold text-[var(--c-text)] text-sm mb-1">{"🤝"} Charte PawBand</p>
      ...
      <div className="w-full max-w-md flex flex-col gap-2 mb-3 relative z-10 animate-slide-up">
          ...
          <div className="flex items-center justify-center">
            <div className="inline-flex rounded-full p-0.5 glass" style={{ borderColor: smartMode ? "rgba(167,139,250,0.4)" : "var(--c-border)" }}>
              <button
                ...
                style={{
                  background: !smartMode ? "linear-gradient(135deg, #FBBF24, #F59E0B)" : "transparent",
        ...
        <div className="flex items-center gap-2">
          ...
          {streak >= 3 && (
            <span className="px-2 py-0.5 glass text-amber-200 rounded-full text-xs font-bold neon-green"
          ...
          <div className="w-16 h-1.5 glass rounded-full overflow-hidden">
            <div className="h-full rounded-full transition-all duration-500"
              style={{
                ...
                background: smartMode ? "linear-gradient(90deg, #a78bfa, #60a5fa, #38BDF8)" : "linear-gradient(90deg, #FBBF24, #FACC15, #38BDF8)",
              }} />
          </div>
        </div>
        </div>
      ...
      {showPaywall && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
          <div className="relative glass-strong neon-green p-8 max-w-sm w-full text-center animate-scale-in">
            <div className="absolute inset-0 rounded-[24px] gradient-border pointer-events-none" />
            <div className="text-5xl mb-4 animate-float">{"🐾"}</div>
