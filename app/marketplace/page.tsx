...
const CONDITION_BADGE: Record<string, string> = {
  neuf: "bg-amber-400/15 text-amber-300 border-amber-400/25",
  occasion: "bg-amber-400/15 text-amber-300 border-amber-400/25",
    ...
    <div className="min-h-screen pb-32" style={{ background: "var(--c-deep)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 pt-8 pb-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold gradient-text-warm mb-0">
            Marketplace PawlyApp
          </h1>
        </div>
            ...
            <button
              ...
              className={
                ...
                (tab === t.key
                  ...
                  : "border-[var(--c-border)] text-[var(--c-text-muted)] hover:border-amber-400/30 hover:text-amber-300")
              }
            >
              {t.label}
            </button>
        ...
        <div className="flex gap-3 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl text-sm glass border border-[var(--c-border)] focus:border-amber-400/50 focus:outline-none transition-all"
                ...
                <div className="p-3">
                  ...
                  {user && user.id !== listing.user_id && (
                    <button
                      ...
                      className="w-full py-1.5 rounded-lg text-xs font-semibold transition-all border hover:bg-amber-400/10"
                      style={{
                        color: "var(--c-text)",
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl text-sm border border-[var(--c-border)] focus:border-amber-400/50 focus:outline-none transition-all"
                  style={{ color: "var(--c-text)", background: "var(--c-glass)" }}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 rounded-xl text-sm border border-[var(--c-border)] focus:border-amber-400/50 focus:outline-none transition-all resize-none"
                  style={{ color: "var(--c-text)", background: "var(--c-glass)" }}
                />
              </div>
                    ...
                    <button
                      ...
                      className={
                        ...
                        (formCondition === c.value
                          ...
                          : "border-[var(--c-border)] text-[var(--c-text-muted)] hover:border-amber-400/20")
                      }
                    >
                      {c.label}
                    </button>
              ...
              <div>
                ...
                <div
                  className="relative border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all hover:border-amber-400/40"
