        ...
        <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input type="text" name="pedigree" placeholder="Ex: LOF 123456, SHSB/LOS 789..." className="w-full bg-[var(--c-card)] border border-[var(--c-border)] rounded-xl px-4 py-2.5 text-sm text-[var(--c-text)] focus:ring-1 focus:ring-amber-400 outline-none" />
            </div>

            {/* Sante */}
            <div className="flex gap-6">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="vaccinated" className="w-4 h-4 rounded bg-[var(--c-card)] border-[var(--c-border)] text-amber-400 focus:ring-amber-400" />
                <span className="text-sm text-[var(--c-text-muted)]">{t.animalVaccinated}</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="sterilized" className="w-4 h-4 rounded bg-[var(--c-card)] border-[var(--c-border)] text-amber-400 focus:ring-amber-400" />
            ...
            <div>
              ...
              <textarea name="description" rows={3}
                className="w-full px-4 py-3 bg-[var(--c-card)] border border-[var(--c-border)] rounded-xl text-[var(--c-text)] placeholder-[var(--c-text-muted)] focus:ring-2 focus:ring-amber-400 focus:border-transparent outline-none transition resize-none"
            ...
            <button type="submit" disabled={loading || !hasOwnerPhoto}
              ...
              style={{
                background: hasOwnerPhoto ? "#FBBF24" : "rgba(34, 197, 94,0.15)",
                color: hasOwnerPhoto ? "#fff" : "#FBBF24",
