...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    heroSub: "PawBand connecte les propriétaires d'animaux près de chez toi pour des balades, jeux et rencontres entre compagnons.",
    ...
    testimonial1: "Depuis PawBand, mon chien a 3 copains de balade réguliers. Il est tellement plus épanoui !",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "Avec Kiko, Border Collie",
    testimonial2: "J'ai déménagé à Genève et grâce à PawBand, j'ai trouvé des balades pour mon chat en 2 jours.",
    ...
    // Share / Viral
    shareTitle: "Invite tes amis", shareDesc: "Gagne des récompenses en partageant PawBand",
    ...
    spotlightDefault: "Mascotte PawBand", spotlightBy: "par",
    spotlightBecomeMascot: "Devenir la Mascotte PawBand",
    ...
    // Why PawBand
    whyTitle: "Pourquoi PawBand ?",
    whyGoogle: "Google vous donne des liens. PawBand vous donne des copains.",
    whyChatGPT: "ChatGPT ne connaît pas votre animal. PawBand, si.",
    ...
    join: "Rejoindre PawBand", explore: "Explorer",
    ...
    pricingDesc: "Débloque toutes les fonctionnalités de PawBand et connecte-toi avec encore plus de compagnons.",
    ...
    pricingFeatSpotlight1m: "👑 Mascotte PawBand 1 minute", pricingFeatSpotlight24h: "👑 Mascotte PawBand 24 heures",
    pricingChoosePlus: "Choisir PawPlus", pricingChoosePro: "Choisir PawPro",

    // Onboarding
    onboardWelcome: "Bienvenue sur PawBand !", onboardSpecies: "Ajoutons ton premier compagnon. Quelle espèce est-ce ?",
    ...
    cardScanProfile: "Scannez pour voir le profil", cardPoweredBy: "Propulsé par PawBand",
    ...
    feedStreakMsg30: "30 jours ! Tu es une légende PawBand",
  ...
  de: {
    ...
    heroSub: "PawBand verbindet Tierhalter in deiner Nähe für Spaziergänge, Spiel und Treffen zwischen Begleitern.",
    ...
    testimonial1: "Seit PawBand hat mein Hund 3 regelmässige Spaziergang-Freunde. Er ist so viel glücklicher!",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "Mit Kiko, Border Collie",
    testimonial2: "Ich bin nach Genf gezogen und dank PawBand habe ich in 2 Tagen Spaziergänge für meine Katze gefunden.",
    ...
    shareTitle: "Freunde einladen", shareDesc: "Verdiene Belohnungen durch Teilen von PawBand",
    ...
    spotlightDefault: "PawBand-Maskottchen", spotlightBy: "von",
    spotlightBecomeMascot: "PawBand-Maskottchen werden",
    ...
    whyTitle: "Warum PawBand?",
    whyGoogle: "Google gibt Ihnen Links. PawBand gibt Ihnen Freunde.",
    whyChatGPT: "ChatGPT kennt Ihr Tier nicht. PawBand schon.",
    ...
    join: "PawBand beitreten", explore: "Entdecken",
    ...
    pricingFeatSpotlight1m: "👑 PawBand-Maskottchen 1 Minute", pricingFeatSpotlight24h: "👑 PawBand-Maskottchen 24 Stunden",
    pricingChoosePlus: "PawPlus wählen", pricingChoosePro: "PawPro wählen",

    onboardWelcome: "Willkommen bei PawBand!", onboardSpecies: "Fügen wir dein erstes Tier hinzu. Welche Tierart?",
    ...
    cardScanProfile: "Scannen Sie das Profil", cardPoweredBy: "Powered by PawBand",
    ...
    feedStreakMsg30: "30 Tage! Du bist eine PawBand-Legende",
  ...
  it: {
    ...
    heroSub: "PawBand collega i proprietari di animali vicino a te per passeggiate, giochi e incontri tra compagni.",
    ...
    testimonial1: "Da quando uso PawBand, il mio cane ha 3 amici di passeggiata regolari. È molto più felice!",
    testimonial1Author: "Sophie, Losanna",
    testimonial1Pet: "Con Kiko, Border Collie",
    testimonial2: "Mi sono trasferito a Ginevra e grazie a PawBand ho trovato passeggiate per il mio gatto in 2 giorni.",
    ...
    shareTitle: "Invita amici", shareDesc: "Guadagna ricompense condividendo PawBand",
    ...
    spotlightDefault: "Mascotte PawBand", spotlightBy: "di",
    spotlightBecomeMascot: "Diventa la Mascotte PawBand",
    ...
    whyTitle: "Perché PawBand?",
    whyGoogle: "Google vi dà link. PawBand vi dà amici.",
    whyChatGPT: "ChatGPT non conosce il vostro animale. PawBand sì.",
    ...
    join: "Unisciti a PawBand", explore: "Esplora",
    ...
    pricingFeatSpotlight1m: "👑 Mascotte PawBand 1 minuto", pricingFeatSpotlight24h: "👑 Mascotte PawBand 24 ore",
    pricingChoosePlus: "Scegli PawPlus", pricingChoosePro: "Scegli PawPro",

    onboardWelcome: "Benvenuto su PawBand!", onboardSpecies: "Aggiungiamo il tuo primo compagno. Che specie è?",
    ...
    cardScanProfile: "Scansiona per il profilo", cardPoweredBy: "Powered by PawBand",
    ...
    feedStreakMsg30: "30 giorni! Sei una leggenda PawBand",
  ...
  en: {
    ...
    heroSub: "PawBand connects pet owners near you for walks, playdates and meetups between companions.",
    ...
    testimonial1: "Since PawBand, my dog has 3 regular walk buddies. He's so much happier!",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "With Kiko, Border Collie",
    testimonial2: "I moved to Geneva and thanks to PawBand, I found walks for my cat in 2 days.",
    ...
    shareTitle: "Invite friends", shareDesc: "Earn rewards by sharing PawBand",
    ...
    spotlightDefault: "PawBand Mascot", spotlightBy: "by",
    spotlightBecomeMascot: "Become the PawBand Mascot",
    ...
    whyTitle: "Why PawBand?",
    whyGoogle: "Google gives you links. PawBand gives you friends.",
    whyChatGPT: "ChatGPT doesn't know your pet. PawBand does.",
    ...
    join: "Join PawBand", explore: "Explore",
    ...
    pricingFeatSpotlight1m: "👑 PawBand Mascot for 1 minute", pricingFeatSpotlight24h: "👑 PawBand Mascot for 24 hours",
    pricingChoosePlus: "Choose PawPlus", pricingChoosePro: "Choose PawPro",

    onboardWelcome: "Welcome to PawBand!", onboardSpecies: "Let's add your first companion. What species?",
    ...
    cardScanProfile: "Scan to view profile", cardPoweredBy: "Powered by PawBand",
    ...
    feedStreakMsg30: "30 days! You're a PawBand legend",
