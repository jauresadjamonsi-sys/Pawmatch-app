...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    heroSub: "PawlyApp connecte les propriétaires d'animaux près de chez toi pour des balades, jeux et rencontres entre compagnons.",
    ...
    testimonial1: "Depuis PawlyApp, mon chien a 3 copains de balade réguliers. Il est tellement plus épanoui !",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "Avec Kiko, Border Collie",
    testimonial2: "J'ai déménagé à Genève et grâce à PawlyApp, j'ai trouvé des balades pour mon chat en 2 jours.",
    ...
    // Share / Viral
    shareTitle: "Invite tes amis", shareDesc: "Gagne des récompenses en partageant PawlyApp",
    ...
    spotlightDefault: "Mascotte PawlyApp", spotlightBy: "par",
    spotlightBecomeMascot: "Devenir la Mascotte PawlyApp",
    ...
    // Why PawlyApp
    whyTitle: "Pourquoi PawlyApp ?",
    whyGoogle: "Google vous donne des liens. PawlyApp vous donne des copains.",
    whyChatGPT: "ChatGPT ne connaît pas votre animal. PawlyApp, si.",
    ...
    join: "Rejoindre PawlyApp", explore: "Explorer",
    ...
    pricingDesc: "Débloque toutes les fonctionnalités de PawlyApp et connecte-toi avec encore plus de compagnons.",
    ...
    pricingFeatSpotlight1m: "👑 Mascotte PawlyApp 1 minute", pricingFeatSpotlight24h: "👑 Mascotte PawlyApp 24 heures",
    pricingChoosePlus: "Choisir PawPlus", pricingChoosePro: "Choisir PawPro",

    // Onboarding
    onboardWelcome: "Bienvenue sur PawlyApp !", onboardSpecies: "Ajoutons ton premier compagnon. Quelle espèce est-ce ?",
    ...
    cardScanProfile: "Scannez pour voir le profil", cardPoweredBy: "Propulsé par PawlyApp",
    ...
    feedStreakMsg30: "30 jours ! Tu es une légende PawlyApp",
  ...
  de: {
    ...
    heroSub: "PawlyApp verbindet Tierhalter in deiner Nähe für Spaziergänge, Spiel und Treffen zwischen Begleitern.",
    ...
    testimonial1: "Seit PawlyApp hat mein Hund 3 regelmässige Spaziergang-Freunde. Er ist so viel glücklicher!",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "Mit Kiko, Border Collie",
    testimonial2: "Ich bin nach Genf gezogen und dank PawlyApp habe ich in 2 Tagen Spaziergänge für meine Katze gefunden.",
    ...
    shareTitle: "Freunde einladen", shareDesc: "Verdiene Belohnungen durch Teilen von PawlyApp",
    ...
    spotlightDefault: "PawlyApp-Maskottchen", spotlightBy: "von",
    spotlightBecomeMascot: "PawlyApp-Maskottchen werden",
    ...
    whyTitle: "Warum PawlyApp?",
    whyGoogle: "Google gibt Ihnen Links. PawlyApp gibt Ihnen Freunde.",
    whyChatGPT: "ChatGPT kennt Ihr Tier nicht. PawlyApp schon.",
    ...
    join: "PawlyApp beitreten", explore: "Entdecken",
    ...
    pricingFeatSpotlight1m: "👑 PawlyApp-Maskottchen 1 Minute", pricingFeatSpotlight24h: "👑 PawlyApp-Maskottchen 24 Stunden",
    pricingChoosePlus: "PawPlus wählen", pricingChoosePro: "PawPro wählen",

    onboardWelcome: "Willkommen bei PawlyApp!", onboardSpecies: "Fügen wir dein erstes Tier hinzu. Welche Tierart?",
    ...
    cardScanProfile: "Scannen Sie das Profil", cardPoweredBy: "Powered by PawlyApp",
    ...
    feedStreakMsg30: "30 Tage! Du bist eine PawlyApp-Legende",
  ...
  it: {
    ...
    heroSub: "PawlyApp collega i proprietari di animali vicino a te per passeggiate, giochi e incontri tra compagni.",
    ...
    testimonial1: "Da quando uso PawlyApp, il mio cane ha 3 amici di passeggiata regolari. È molto più felice!",
    testimonial1Author: "Sophie, Losanna",
    testimonial1Pet: "Con Kiko, Border Collie",
    testimonial2: "Mi sono trasferito a Ginevra e grazie a PawlyApp ho trovato passeggiate per il mio gatto in 2 giorni.",
    ...
    shareTitle: "Invita amici", shareDesc: "Guadagna ricompense condividendo PawlyApp",
    ...
    spotlightDefault: "Mascotte PawlyApp", spotlightBy: "di",
    spotlightBecomeMascot: "Diventa la Mascotte PawlyApp",
    ...
    whyTitle: "Perché PawlyApp?",
    whyGoogle: "Google vi dà link. PawlyApp vi dà amici.",
    whyChatGPT: "ChatGPT non conosce il vostro animale. PawlyApp sì.",
    ...
    join: "Unisciti a PawlyApp", explore: "Esplora",
    ...
    pricingFeatSpotlight1m: "👑 Mascotte PawlyApp 1 minuto", pricingFeatSpotlight24h: "👑 Mascotte PawlyApp 24 ore",
    pricingChoosePlus: "Scegli PawPlus", pricingChoosePro: "Scegli PawPro",

    onboardWelcome: "Benvenuto su PawlyApp!", onboardSpecies: "Aggiungiamo il tuo primo compagno. Che specie è?",
    ...
    cardScanProfile: "Scansiona per il profilo", cardPoweredBy: "Powered by PawlyApp",
    ...
    feedStreakMsg30: "30 giorni! Sei una leggenda PawlyApp",
  ...
  en: {
    ...
    heroSub: "PawlyApp connects pet owners near you for walks, playdates and meetups between companions.",
    ...
    testimonial1: "Since PawlyApp, my dog has 3 regular walk buddies. He's so much happier!",
    testimonial1Author: "Sophie, Lausanne",
    testimonial1Pet: "With Kiko, Border Collie",
    testimonial2: "I moved to Geneva and thanks to PawlyApp, I found walks for my cat in 2 days.",
    ...
    shareTitle: "Invite friends", shareDesc: "Earn rewards by sharing PawlyApp",
    ...
    spotlightDefault: "PawlyApp Mascot", spotlightBy: "by",
    spotlightBecomeMascot: "Become the PawlyApp Mascot",
    ...
    whyTitle: "Why PawlyApp?",
    whyGoogle: "Google gives you links. PawlyApp gives you friends.",
    whyChatGPT: "ChatGPT doesn't know your pet. PawlyApp does.",
    ...
    join: "Join PawlyApp", explore: "Explore",
    ...
    pricingFeatSpotlight1m: "👑 PawlyApp Mascot for 1 minute", pricingFeatSpotlight24h: "👑 PawlyApp Mascot for 24 hours",
    pricingChoosePlus: "Choose PawPlus", pricingChoosePro: "Choose PawPro",

    onboardWelcome: "Welcome to PawlyApp!", onboardSpecies: "Let's add your first companion. What species?",
    ...
    cardScanProfile: "Scan to view profile", cardPoweredBy: "Powered by PawlyApp",
    ...
    feedStreakMsg30: "30 days! You're a PawlyApp legend",
