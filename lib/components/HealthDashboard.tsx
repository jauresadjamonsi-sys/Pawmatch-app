...
export function HealthDashboard({ animal, isOwner, editUrl, lang }: HealthProps) {
  ...
  const statusColors = { ok: "#22c55e", warning: "#f59e0b", danger: "#ef4444", none: "#9ca3af" };
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 20, border: "1.5px solid rgba(34,197,94,0.15)", padding: 20, marginBottom: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
        ...
        {isOwner && (
          <a href={editUrl} style={{ fontSize: 11, color: "#22c55e", fontWeight: 700, textDecoration: "none" }}>
            ✏️ {l.edit}
          </a>
        )}
      </div>
