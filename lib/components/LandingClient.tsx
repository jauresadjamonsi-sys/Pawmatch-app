...
/* VisitCounter removed from public landing — admin only */

/* ──────────────────────────────────────────
   FLOATING PARTICLES COMPONENT
   ────────────────────────────────────────── */
const PARTICLES = [
  { color: "rgba(251,191,36,0.25)", size: 5, left: "10%", duration: "14s", delay: "0s" },
  ...
  { color: "rgba(251,191,36,0.18)", size: 3, left: "65%", duration: "20s", delay: "1s" },
  ...
  { color: "rgba(251,191,36,0.2)", size: 3, left: "35%", duration: "19s", delay: "6s" },
  ...
  return (
    <div className="min-h-screen bg-[var(--c-deep)] text-[var(--c-text)] overflow-hidden relative">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-6">
        ...
        <div className="relative z-10 max-w-2xl mx-auto animate-slide-up">
            ...
            {spotlight?.active && spotlight.animal_photo ? (
              <>
                ...
                <div className="relative w-32 h-32 sm:w-40 sm:h-40 mx-auto rounded-full overflow-hidden" style={{
                  boxShadow: "0 0 30px rgba(168,85,247,0.5), 0 0 60px rgba(251,191,36,0.2)",
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            ...
            <div className="px-4 py-2 flex items-center gap-2 text-xs font-bold rounded-full" style={{ background: "rgba(251,191,36,0.1)", border: "1px solid rgba(251,191,36,0.2)", color: "#FBBF24" }}>
              {t.heroBadgeFree}
            </div>
            <div className="glass px-4 py-2 flex items-center gap-2 text-xs font-medium" style={{ borderRadius: 40 }}>
          ...
          <p className="text-xs" style={{ color: "var(--c-text-muted)" }}>
            {t.heroJoinOwners}{" "}
            <span className="font-bold" style={{ color: "var(--c-accent, #FBBF24)" }}>
      ...
      >
        ...
        <div className="h-1 w-16 mx-auto rounded-full mb-12" style={{ background: "linear-gradient(90deg, #FBBF24, #A78BFA, #38BDF8)" }} />

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative stagger-children">
          {/* Gradient connector lines (desktop) */}
          <div className="hidden md:block absolute top-1/2 left-[33%] right-[33%] h-[2px] gradient-line" style={{ width: "34%", left: "16.5%", background: "linear-gradient(90deg, #FBBF24, #A78BFA)" }} />
          ...
          {TESTIMONIALS.map((testi, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-bold" style={{ color: "var(--c-accent, #FBBF24)" }}>
                    {t[testi.authorKey]}
                  </p>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 mb-24">
        ...
        <div className="h-1 w-16 mx-auto rounded-full mb-8" style={{ background: "linear-gradient(90deg, #FBBF24, #A78BFA, #38BDF8)" }} />
        ...
        <div className="text-center">
          <Link href="/pricing" className="glass px-6 py-2.5 font-semibold text-xs hover:scale-105 transition-transform inline-block" style={{ borderRadius: 40, color: "var(--c-accent, #FBBF24)" }}>
            {t.whyTitle} →
          </Link>
        </div>
      </section>
