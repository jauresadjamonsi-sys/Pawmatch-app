    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className="px-4 py-2 bg-gradient-to-r from-amber-400 to-amber-500 text-white text-xs font-bold rounded-full hover:from-amber-500 hover:to-amber-600 transition shadow-lg shadow-amber-400/20 disabled:opacity-50"
        >
