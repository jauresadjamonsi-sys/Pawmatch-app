  ...
  return (
    <div className="glass rounded-2xl p-4 border border-[var(--c-border)] animate-slide-up relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {allDailyClaimed && (
          <span className="text-xs px-2 py-0.5 rounded-full bg-amber-400/15 text-amber-300 font-medium animate-badge-bounce">
            Tout complete ✓
          </span>
        )}
      </div>
...
function ChallengeRow({
  ...
  return (
    ...
    >
          ...
          <div
            ...
            style={{
              ...
              background: ch.completed
                ...
                : "linear-gradient(90deg, #FBBF24, var(--c-accent))",
            }}
          />
        </div>
      ...
      {/* Reward / Claim */}
      {ch.claimed ? (
        <span className="text-sm text-amber-300 font-bold flex-shrink-0">✓</span>
      ) : ch.completed ? (
        <button
