  ...
  if (success) {
    return (
      <div style={{
        ...
        background: "linear-gradient(135deg, rgba(34,197,94,0.12), rgba(168,85,247,0.08))",
        border: "2px solid rgba(34,197,94,0.3)", borderRadius: 16, marginBottom: 16,
      }}>
        <div style={{
    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <button
        ...
        style={{
          ...
          background: occupied
            ...
            : "linear-gradient(135deg, rgba(34,197,94,0.1), rgba(168,85,247,0.06))",
          border: occupied
      ...
      {!isPremium && !occupied && (
        <div style={{
          ...
          <Link href="/pricing" style={{ color: "#22C55E", fontWeight: 700, textDecoration: "none", marginLeft: 4 }}>
            Premium →
          </Link>
        </div>
      )}
