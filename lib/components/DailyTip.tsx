...
function getTips(animal: DailyTipProps["animal"]): Tip[] {
  ...
  const tips: Tip[] = [
    ...
    { emoji: "🐕‍🦺", title: "Socialisation", body: `Une rencontre avec un autre animal est excellente pour ${animal.name}. La socialisation régulière réduit l'anxiété et améliore le comportement.`, cta: { label: "Trouver un copain de balade →", url: "https://pawband.ch/flairer" } },
