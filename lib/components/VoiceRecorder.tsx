    ...
    <>
      ...
      <div className="flex items-center gap-3 flex-1 px-3 py-2 bg-[var(--c-card)] border border-red-500/30 rounded-2xl">
        ...
        <button
          ...
          className="w-9 h-9 bg-gradient-to-br from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 disabled:opacity-30 rounded-full flex items-center justify-center transition active:scale-95 flex-shrink-0"
          title="Envoyer"
        >
