      ...
      <>
        ...
        {!showIOSGuide && (
          <div className="fixed bottom-20 left-4 right-4 z-[60] animate-slide-up">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-lg flex-shrink-0 shadow-lg shadow-amber-500/30">
                🐾
              </div>
              ...
              <button
                ...
                className="flex-shrink-0 px-3 py-1.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-bold rounded-full shadow-lg shadow-amber-500/20"
              >
                Comment ?
              </button>
              <button
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[70] flex items-end justify-center p-4">
            <div className="animate-slide-up w-full max-w-md rounded-3xl border overflow-hidden"
              ...
              <div className="p-6 text-center">
                ...
                <div className="space-y-4 text-left">
                  <div className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold">1</span>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold">2</span>
                    <div>
                      <p className="text-sm font-medium text-[var(--c-text)]">Scrolle vers le bas et appuie sur <span className="inline-block px-1.5 py-0.5 bg-amber-500/20 text-amber-400 rounded text-xs font-mono">＋ Sur l&apos;&eacute;cran d&apos;accueil</span></p>
                      <p className="text-xs text-[var(--c-text-muted)] mt-0.5">C&apos;est en dessous de &laquo;&nbsp;Ajouter un signet&nbsp;&raquo;</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold">3</span>
                    <div>
              ...
              <div className="flex border-t" style={{ borderColor: "var(--c-border)" }}>
                ...
                <button onClick={handleDismiss}
                  className="flex-1 py-3.5 text-sm font-bold text-amber-400 hover:text-amber-300 transition">
                  Compris !
                </button>
              </div>
            </div>
    ...
    <div className="fixed bottom-20 left-4 right-4 z-[60] animate-slide-up md:left-auto md:right-6 md:max-w-sm">
      ...
      >
        ...
        <button
          ...
          className="flex-shrink-0 px-3 py-1.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-bold rounded-full shadow-lg shadow-amber-500/20 active:scale-95 transition-transform"
        >
          Installer
        </button>
        <button
